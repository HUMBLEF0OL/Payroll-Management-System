...
//		t1.setBorder(BorderFactory.createEmptyBorder(10, 20, 10, 10));
		p1.add(l1);
		p1.add(t1);
		...
		// now converting our grid of data into BorderLayout
	...
	public void actionPerformed(ActionEvent ae) {
		...
		String p = t7.getText();
		// writing the query 
		// here are adding null because that field is of ID which will be auto generated by the database
		String qry = "insert into employee values(null,'" + n + "','" + g + "','" + a + "','" + s + "','" + c + "','"
				+ e + "','" + p + "')";

		try {
			// creating the object of the connection
			conn c1 = new conn();
			// using executeUpdate to push the data into database
